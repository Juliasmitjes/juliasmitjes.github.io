    ...
    return (
        <div id="example">
            ...
            <div className="inputs">
               ...
               <motion.div
      initial={{ x: 200, opacity: 0 }}   // Startpositie: 200px naar rechts en onzichtbaar
      animate={{ x: 0, opacity: 1 }}     // Eindpositie: op originele plek en zichtbaar
      transition={{ duration: 1.0 }}     // Duur van de animatie
      style={{
        background: '#f0f0f0',
        padding: '2rem',
        borderRadius: '8px',
